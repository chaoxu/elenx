...
SQLite serializes appends and unique indexes arbitrate conflicting verdicts, so v1 has no native process-lifetime lock or current-process activity model. A call start without a result honestly means interrupted work. Applications decide whether and how to retry it.
