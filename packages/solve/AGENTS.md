...
6. Run one correctness review and one simplification review concurrently against that diff.
7. Wait at most ten minutes. Correctness, security, regression, and direct user-requirement findings block; advisory cleanup does not.
